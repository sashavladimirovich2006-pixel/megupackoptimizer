        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Item {
                    ...
                    ColorOverlay {
                        anchors.fill: driveOptIconImg
                        source: driveOptIconImg
                        color: Theme.accent
                    }
                }
            }
            ...
            Column {
                ...
                Row {
                    ...
                    ShowPathButton {
                        anchors.verticalCenter: parent.verticalCenter
                        onClicked: {
                            optimizerBackend.showPath("driveoptimization");
                        }
                    }
                }
                Text {
                    text: qsTr("Helps your device run more efficiently")
                    color: Theme.textSecondary
                    font.family: Theme.fontFamily
                    font.pixelSize: 10
                    width: parent.width
            ...
            MeguSwitch {
                id: driveOptSwitch
                Layout.alignment: Qt.AlignVCenter
                checked: optimizerBackend.driveOptimizationActive
                onToggled: (isChecked) => {
                    optimizerBackend.driveOptimizationActive = isChecked;
                }
            }
        }
    }
